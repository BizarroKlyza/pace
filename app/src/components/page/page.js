        ...
        <div className="HeaderContainer">
          ...
          <div className="HeaderRow" id="headerRowTwo">
            ...
            <div className="NavMenuContainer">
              <ul>
                <li><a href="#" onClick={(e)=>(this.handleNavigation("Results"))}>Results</a></li>
                <li><a href="#" onClick={(e)=>(this.handleNavigation("General"))}>General</a></li>
                <li><a href="#" onClick={(e)=>(this.handleNavigation("Trend"))}>Trend</a></li>
                <li><a href="#" onClick={(e)=>(this.handleNavigation("Source"))}>Source Map</a></li>
              </ul>
            </div>
          </div>
        </div>
